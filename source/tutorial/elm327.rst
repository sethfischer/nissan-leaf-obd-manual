...
While the *Leaf* has a 16-pin OBD-II :term:`diagnostic connector` in compliance
with :term:`ISO 15031-3`, and the Car-CAN protocol complies with
ISO 15765‑4 (CAN 11/500), the vehicle does not support the standard
:term:`PIDs<PID>` which are mandated for internal combustion engine vehicles.
